<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SingIn.aspx.cs" Inherits="SingIn" %>
    ...
    <form id="form1" runat="server">
      ...
      <table class="auto-style24">
	    ...
	    <tr><td class="auto-style19">
            <br /> <br /> <br /> <br />
            <asp:Label ID="lblUsername" runat="server" Font-Size="20pt" Text="Username"></asp:Label> &nbsp
            <asp:TextBox ID="txtUsername" runat="server" Width="168px"></asp:TextBox>
            <br />
            <asp:Label ID="lblPassword" Font-Size="20pt" runat="server" Text="Password"></asp:Label> &nbsp
            <asp:TextBox ID="txtPassword" runat="server" TextMode="Password"></asp:TextBox>
            <br /> <br />
            <asp:Button class="btn" ID="btnSingIn" runat="server" OnClick="btnSingIn_Click" Text="Sign In" />
  </td>
